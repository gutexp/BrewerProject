...
public class CervejasImpl implements CervejasQueries {
	...
	public List<CervejaDTO> porSkuOuNome(String skuOuNome) {
		...
		String jpql = "select new com.algaworks.brewer.dto.CervejaDTO(codigo, sku, nome, origem, valor, foto) "+ "from Cerveja where lower(sku) like lower(:skuOuNome) or lower(nome) like lower(:skuOuNome)";
