...
public class PageWrapper<T> {
	...
	//através desse wrapper podemos codar coisas que estávamos utilizando no nosso html, deixando as nossas tags mais limpas fazendo apenas chamadas de metódos presentes aqui
	private Page<T> page;
